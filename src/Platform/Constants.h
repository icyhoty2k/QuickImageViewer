...
// =========================================================================
#define VER_NUMERIC 1,8,0,0        // Numeric version for file properties (4 comma-separated integers) must be exactly 4 numbers separated by commas
#define VER_STR "1.8.0"            // Human-readable version string; may contain text such as "1.5 Beta"
