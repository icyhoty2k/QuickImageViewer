...
void TrayHandler::DispatchCommand(HWND hWnd, int cmd) {
    ...
    case 11: {
        ...
        if (anyKey) {
            // Re-read all settings from registry (mirrors startup logic)
            ...
            app.vramCacheCount = std::max(0, std::min(999, static_cast<int>(
            ...
            app.baseWidth = std::max(240, std::min(16000, static_cast<int>(
                Persistence::Registry::LoadSetting(Constants::Registry::BASE_WIDTH_KEY,
                    static_cast<DWORD>(Constants::IS_BASE_WIDTH)))));
            app.baseHeight = std::max(240, std::min(16000, static_cast<int>(
            ...
            app.historyMaxDirs = std::max(0, std::min(999, static_cast<int>(
            ...
            app.historyMaxFavs = std::max(0, std::min(999, static_cast<int>(
            ...
            app.dirThumbCacheMB = std::max(100, std::min(64000, static_cast<int>(
            ...
            app.preloadLookaside = std::max(1, std::min(99, static_cast<int>(
            ...
            app.msgCenterDisplayMs = std::max(250, std::min(10000, static_cast<int>(
            ...
            app.historyMaxDirsSave = std::max(1, std::min(99999, static_cast<int>(
            ...
            app.slideshow.intervalMs = std::max(100, std::min(60000, static_cast<int>(
            ...
            app.fileHandlerDefaultSortOrder = std::max(0, std::min(4, static_cast<int>(
