...
It delivers 90%+ feature parity with legacy viewers at a fraction of the footprint (sub-1 MB).
...
You can download the latest version of the viewer from the **[Releases page](https://github.com/icyhoty2k/QuickImageViewer/releases/latest)**.

> *Built with native C++ for maximum efficiency (sub-1 MB).*

---

## ✨ Features

* **⚡ Extreme Efficiency:** sub-1 MB footprint with near-instant startup.
...
Simply download the latest binary from the **[Releases page](https://github.com/icyhoty2k/QuickImageViewer/releases/latest)**.
...
Designed for developers who value explicit, direct code over declarative abstractions:
